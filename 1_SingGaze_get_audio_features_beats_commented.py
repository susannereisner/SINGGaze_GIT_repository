...
for ppt_id in ppt_id_list:
    ...
    print("save")
    # np.save('W:/hoehl/projects/sing/Acoustic_analysis_SRE/specflux_python/beats/npy_files/SF/'+ppt_id+'_SF.npy', SF)
    # np.save('W:/hoehl/projects/sing/Acoustic_analysis_SRE/specflux_python/beats/npy_files/env/'+ppt_id+'_env.npy', env)
    # np.save('W:/hoehl/projects/sing/Acoustic_analysis_SRE/specflux_python/beats/npy_files/tempi/'+ppt_id+'_tempi.npy', tempi)
    # np.save('W:/hoehl/projects/sing/Acoustic_analysis_SRE/specflux_python/beats/npy_files/pitch/'+ppt_id+'_pitch.npy', pitch)
    np.save('W:/hoehl/projects/sing/Acoustic_analysis_SRE/specflux_python/beats/npy_files/SF/'+ppt_id+'_SF21.npy', SF)
    np.save('W:/hoehl/projects/sing/Acoustic_analysis_SRE/specflux_python/beats/npy_files/env/'+ppt_id+'_env21.npy', env)
    # np.save('W:/hoehl/projects/sing/Acoustic_analysis_SRE/specflux_python/beats/npy_files/tempi/'+ppt_id+'_tempi.npy', tempi)
    np.save('W:/hoehl/projects/sing/Acoustic_analysis_SRE/specflux_python/beats/npy_files/pitch/'+ppt_id+'_pitch21.npy', pitch)
