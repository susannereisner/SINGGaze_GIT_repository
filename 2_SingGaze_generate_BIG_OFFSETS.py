# -*- coding: utf-8 -*-
"""
Created on Fri Feb 28 13:07:16 2025
...
df_start_end = pd.read_csv('W:/hoehl/projects/sing/Logs/SINGGAZE_audiolengths_SRE.csv')
...
output_dir_big = 'W:/hoehl/projects/sing/Acoustic_analysis_SRE/specflux_python/seconds/revision/revision_npy_BIG_offsets/'
...
for ppt_id in ppt_id_list:
    ...
    SF = np.load('W:/hoehl/projects/sing/Acoustic_analysis_SRE/specflux_python/seconds/new_npy_files/new_SF/'+
        ppt_id + '_SF.npy')

    env = np.load('W:/hoehl/projects/sing/Acoustic_analysis_SRE/specflux_python/seconds/new_npy_files/new_env/'+
        ppt_id + '_env.npy')

    F0 = np.load('W:/hoehl/projects/sing/Acoustic_analysis_SRE/specflux_python/seconds/new_npy_files/new_pitch/'+
        ppt_id + '_pitch.npy')
